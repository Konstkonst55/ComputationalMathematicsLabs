...
namespace _4
{
    public class BisectionMethod : RootFindingMethod
    {
        public BisectionMethod(Func<double, double> function, double tolerance = 1e-6)
            : base(function, tolerance) { }

        protected override double FindC(double a, double b) => (a + b) / 2;
